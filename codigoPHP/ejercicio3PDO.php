...
<html>
    ...
    <body>
        ...
        if (isset($_POST['enviar']) && $_POST['enviar'] == 'Enviar') {
            ...
            $aErrores['FechaBaja'] = validacionFormularios::validarFecha($_POST['FechaBaja'], NOOBLIGATORIO);
            $aErrores['VolumenNegocio'] = validacionFormularios::comprobarFloat($_POST['VolumenNegocio'], 100000, 1, NOOBLIGATORIO);
...
//                
                ...
                $sentencia->bindParam(":fecha", $_POST["FechaBaja"]);
                $sentencia->bindParam(":valor", $_POST["VolumenNegocio"]);
                $sentencia->execute();
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <fieldset>
                    ...
                    <div class="obligatorio">
                        ...
                        <input type="text" name="FechaBaja" class="form-control" value="<?php
